...
import static gaml.core.operators.Maths.round;
...
import gama.annotations.common.interfaces.IAttributed;
...
public class GamaPoint extends Coordinate implements IShape, ILocation, IIntersectable {
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.core.interfaces.IGeometry#setGeometry(gama.core.util.GamaGeometry)
	 */
	@Override
	public void setGeometry(final IShape g) {
	...
	/**
	 * @see gama.core.interfaces.IGeometry#getInnerGeometry()
	 */
	@Override
	public Geometry getInnerGeometry() { return GeometryUtils.GEOMETRY_FACTORY.createPoint(this); }

	/**
	 * @see gama.core.interfaces.IGeometry#getEnvelope()
	 */
	@Override
	...
	/**
	 * @see gama.core.interfaces.IGeometry#covers(gama.core.interfaces.IGeometry)
	 */
	@Override
	...
	/**
	 * @see gama.core.interfaces.IGeometry#euclidianDistanceTo(gama.core.interfaces.IGeometry)
	 */
	@Override
	...
	/**
	 * @see gama.core.interfaces.IGeometry#intersects(gama.core.interfaces.IGeometry)
	 */
	@Override
	...
	/**
	 * @see gama.core.interfaces.IGeometry#getAgent()
	 */
	@Override
	public IAgent getAgent() { return null; }

	/**
	 * @see gama.core.interfaces.IGeometry#setAgent(gama.core.interfaces.IAgent)
	 */
	@Override
