...
public interface IAgent extends IShape, INamed, Comparable<IAgent>, IStepable, IContainer.Addressable<String, Object>,
	...
	/**
	 * @see gama.core.interfaces.IShape#getInnerGeometry()
	 */
	@Override
	 ...
	 *
	 * @see gama.core.interfaces.IShape#getEnvelope()
	 */
	@Override
	...
	/**
	 * @see gama.core.interfaces.IShape#covers(gama.core.interfaces.IGeometry)
	 */
	@Override
	...
	/**
	 * @see gama.core.interfaces.IShape#euclidianDistanceTo(gama.core.interfaces.IGeometry)
	 */
	@Override
