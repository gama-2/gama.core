...
public class NoCacheNeighborhood implements INeighborhood {
	 ...
	 *
	 * @see gama.core.metamodel.topology.grid.INeighborhood#getNeighborsIn(int, int)
	 */
	@Override
	 ...
	 * Method isVN()
	 *
	 * @see gama.core.metamodel.topology.grid.INeighborhood#isVN()
	 */
	@Override
	public boolean isVN() {
		return false;
	 ...
	 *
	 * @see gama.core.metamodel.topology.grid.INeighborhood#getRawNeighborsIncluding(int, int)
	 */
	@Override
	 ...
	 *
	 * @see gama.core.metamodel.topology.grid.INeighborhood#neighborsIndexOf(int, int)
	 */
	@Override
