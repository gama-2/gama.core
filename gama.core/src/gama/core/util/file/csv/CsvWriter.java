...
public class CsvWriter implements Closeable {
	...
	/**
	 * Creates a {@link gama.core.util.file.csv.csvreader.CsvWriter CsvWriter} object using a file as the data
	 * destination.
	 *
	 * @param fileName
	...
	/**
	 * Creates a {@link gama.core.util.file.csv.csvreader.CsvWriter CsvWriter} object using a Writer to write data to.
	 *
	 * @param outputStream
