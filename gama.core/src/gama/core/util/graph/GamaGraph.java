/*******************************************************************************************************
 *
 * GamaGraph.java, in msi.gama.core, is part of the source code of the GAMA modeling and simulation platform (v.1.9.0).
 *
...
import gaml.core.operators.Graphs.EdgeToAdd;
import gaml.core.operators.Graphs.GraphObjectToAdd;
import gaml.core.operators.Spatial.Creation;
import gaml.core.species.ISpecies;
import gaml.core.types.GamaListType;
import gaml.core.types.GamaPairType;
...
//				setEdgeWeight(e, graph.getEdgeWeight(e));
	...
	@Override
	public void addValue(final IScope scope, final gaml.core.operators.Graphs.GraphObjectToAdd value) {
		if (value instanceof gaml.core.operators.Graphs.EdgeToAdd edge) {
			...
			final gaml.core.operators.Graphs.NodeToAdd node = (gaml.core.operators.Graphs.NodeToAdd) value;
	...
	public void addValueAtIndex(final IScope scope, final Object idx,
			final gaml.core.operators.Graphs.GraphObjectToAdd value) {
	...
	public void addValues(final IScope scope, final Object index, final IContainer values) {
		...
		if (values instanceof GamaGraph) {
			...
			for (final Object o : values.iterable(scope)) {
				if (o instanceof gaml.core.operators.Graphs.GraphObjectToAdd) {
					addValue(scope, (gaml.core.operators.Graphs.GraphObjectToAdd) o);
				}
			}
		}
	...
	@Override
	public void setAllValues(final IScope scope, final gaml.core.operators.Graphs.GraphObjectToAdd value) {
	...
	public void removeValue(final IScope scope, final Object value) {
		...
		} else if (value instanceof gaml.core.operators.Graphs.NodeToAdd) {
			removeVertex(((gaml.core.operators.Graphs.NodeToAdd) value).object);
	...
	public boolean addVertex(final Object v) {
		if (v instanceof gaml.core.operators.Graphs.GraphObjectToAdd) {
			if (v instanceof IAgent && !this.getVertices().isEmpty() && ((IAgent) v).getSpecies() != vertexSpecies) {
				vertexSpecies = null;
			}
			addValue(graphScope, (gaml.core.operators.Graphs.GraphObjectToAdd) v);
			return ((gaml.core.operators.Graphs.GraphObjectToAdd) v).getObject() != null;
		}
	...
	/**
	 * @see gama.core.interfaces.IGamaContainer#any()
	 */
	@Override
	 ...
	 *      gaml.core.types.IContainerType)
	 */
	@Override
	public gaml.core.operators.Graphs.GraphObjectToAdd buildValue(final IScope scope, final Object object) {
		if (object instanceof gaml.core.operators.Graphs.NodeToAdd) return new gaml.core.operators.Graphs.NodeToAdd(
				type.getKeyType().cast(scope, ((gaml.core.operators.Graphs.NodeToAdd) object).object, null, false),
				((gaml.core.operators.Graphs.NodeToAdd) object).weight);
		if (object instanceof gaml.core.operators.Graphs.EdgeToAdd) return new gaml.core.operators.Graphs.EdgeToAdd(
				type.getKeyType().cast(scope, ((gaml.core.operators.Graphs.EdgeToAdd) object).source, null, false),
				type.getKeyType().cast(scope, ((gaml.core.operators.Graphs.EdgeToAdd) object).target, null, false),
				type.getContentType().cast(scope, ((gaml.core.operators.Graphs.EdgeToAdd) object).object, null, false),
				((gaml.core.operators.Graphs.EdgeToAdd) object).weight);
		return new gaml.core.operators.Graphs.EdgeToAdd(null, null,
	 ...
	 */
	@Override
	public IContainer<?, gaml.core.operators.Graphs.GraphObjectToAdd> buildValues(final IScope scope,
			final IContainer objects) {
		try (final Collector.AsList list = Collector.getList()) {
			if (!(objects instanceof gaml.core.operators.Graphs.NodesToAdd)) {
				for (final Object o : objects.iterable(scope)) { list.add(buildValue(scope, o)); }
			} else {
				for (final Object o : objects.iterable(scope)) {
					list.add(buildValue(scope, new gaml.core.operators.Graphs.NodeToAdd(o)));
				}
			}
			return list.items();
		}
