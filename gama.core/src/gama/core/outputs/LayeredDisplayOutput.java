...
import gaml.core.descriptions.LabelExpressionDescription;
...
public class LayeredDisplayOutput extends AbstractDisplayOutput {
	...
	public static class DisplaySerializer extends SymbolSerializer<SymbolDescription> {
		 ...
		 *
		 * @see gaml.core.descriptions.SymbolSerializer#collectPluginsInFacetValue(gaml.core.descriptions.SymbolDescription,
