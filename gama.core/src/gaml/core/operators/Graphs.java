/*******************************************************************************************************
 *
 * Graphs.java, in msi.gama.core, is part of the source code of the GAMA modeling and simulation platform (v.1.9.0).
 *
...
import gama.core.util.graph.GamaGraph.kShortestPathAlgorithm;
import gama.core.util.graph.GamaGraph.shortestPathAlgorithm;
...
import gaml.core.skills.GridSkill.IGridAgent;
import gaml.core.species.ISpecies;
import gaml.core.types.GamaGraphType;
import gaml.core.types.GamaPathType;
...
public class Graphs {
	...
	private static class DistanceRelation implements VertexRelationship<IShape> {
		 ...
		 * @see gama.core.util.graph.GamaSpatialGraph.VertexRelationship#related(gama.core.interfaces.IScope,
		 *      gama.core.interfaces.IGeometry, gama.core.interfaces.IGeometry)
		 */
		@Override
		...
		/**
		 * @throws GamaRuntimeException
		 * @see gama.core.util.graph.GamaSpatialGraph.VertexRelationship#equivalent(gama.core.interfaces.IGeometry,
