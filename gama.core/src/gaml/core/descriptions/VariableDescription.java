...
import static gaml.core.descriptions.IDescription.Flag.Unmodifiable;
import static gaml.core.descriptions.IDescription.Flag.Updatable;
...
import gaml.core.compilation.GamaHelper;
...
import gaml.core.types.GamaIntegerType;
...
public class VariableDescription extends SymbolDescription {
	 ...
	 *
	 * @see gaml.core.descriptions.SymbolDescription#getTypeNamed(java.lang.String)
	 */
	@Override
	...
	public String getBuiltInDoc() {
		...
		for (final gama.annotations.precompiler.GamlAnnotations.variable v : vars.value()) {
