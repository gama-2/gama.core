/*******************************************************************************************************
 *
 * SymbolSerializer.java, in msi.gama.core, is part of the source code of the GAMA modeling and simulation platform
 * (v.1.9.0).
 *
...
public class SymbolSerializer<C extends SymbolDescription> implements IKeyword {
	 ...
	 * Method serialize()
	 *
	 * @see gaml.core.descriptions.IDescriptionSerializer#serialize(gaml.core.descriptions.IDescription)
	 */
