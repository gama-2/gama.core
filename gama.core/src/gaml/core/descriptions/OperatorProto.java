...
import gaml.core.compilation.GamaGetter;
import gaml.core.compilation.IValidator;
import gaml.core.compilation.annotations.depends_on;
...
import gaml.core.expressions.operators.NAryOperator;
import gaml.core.expressions.operators.TypeFieldExpression;
import gaml.core.expressions.operators.UnaryOperator;
...
public class OperatorProto extends AbstractProto implements IVarDescriptionUser {
	 ...
	 * Method getKind()
	 *
	 * @see gaml.core.descriptions.AbstractProto#getKind()
	 */
	@Override
