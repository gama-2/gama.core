...
import gaml.core.compilation.IGamlAdditions;
import gaml.core.constants.IConstantsSupplier;
import gaml.core.statements.CreateStatement;
import gaml.core.statements.SaveStatement;
import gaml.core.statements.draw.DrawStatement;
...
public class GamaBundleLoader {
	...
	/** The core models. */
	public static final Bundle CORE_MODELS = Platform.getBundle("gama.models.library");
