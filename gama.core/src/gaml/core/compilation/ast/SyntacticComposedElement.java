...
public class SyntacticComposedElement extends AbstractSyntacticElement {
	 ...
	 * (non-Javadoc)
	 *
	 * @see gaml.core.compilation.ast.AbstractSyntacticElement#addChild(gaml.core.compilation.ast.ISyntacticElement)
	 */
	@Override
	 ...
	 *
	 * @see
	 * gaml.core.compilation.ast.AbstractSyntacticElement#visitThisAndAllChildrenRecursively(gaml.core.compilation.ast.
	 ...
	 * (non-Javadoc)
	 *
	 * @see gaml.core.compilation.ast.AbstractSyntacticElement#visitChildren(gaml.core.compilation.ast.ISyntacticElement.
	 * SyntacticVisitor)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gaml.core.compilation.ast.AbstractSyntacticElement#dispose()
	 */
	@Override
	public void dispose() {
		super.dispose();
